...
public class BuyForm extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void post_buy_book_btn_click(View v)
    {
        Intent intent = this.getIntent();
        EditText name = (EditText) findViewById(R.id.book_contact_name_buy_et);
        EditText contact_name = (EditText) findViewById(R.id.book_contact_name_buy_et);
        EditText contactno = (EditText) findViewById(R.id.book_contact_no_buy_et);
        EditText price = (EditText) findViewById(R.id.book_price_buy_et);
        EditText email = (EditText) findViewById(R.id.book_email_buy_et);
		

        if(checkEditText(name) || checkEditText(contactno)||checkEditText(email) ||checkEditText(contact_name) ||checkEditText(price)   )
        {
        ...
        else
        {
            ...
            res.putDouble("latitude", lat);
            res.putDouble("longitude", lng);
            res.putParcelable("image",imageBitmap);
